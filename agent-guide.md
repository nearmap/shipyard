...
- A language server is the repository's own Claude Code configuration (`lspServers`), never a Shipyard setting — asked how to make Shipyard use one, point at that declaration, not at a config key.
