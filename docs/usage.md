...
- `/sy:tighten <text>` — cut a piece of writing to what it needs to be and pitch it at the reader `text.reader` names, without dropping a decision or a caveat. The other commands invoke it for you on the durable text they author; run it directly on anything you are about to send by hand.
